...
export default function Page() {
  return (
    <div>
      <div className="flex flex-col bg-black justify-center items-center py-24 gap-12">
        <div className="flex flex-col justify-center items-center px-72 gap-4">
        ...
        <div className="flex flex-col justify-center items-center px-72">
          <text className="text-md text-white">Prices:  Lessons are $50 Half Hour Private, $95 Hour Private</text>
          <text className="text-md text-white">We offer a discount card of 5 lessons for $225. </text>
        </div>
      </div>
    </div>
  );
