...
export default function Page() {
  ...
  <div className="flex flex-col">
    <div className="flex flex-col justify-center items-center bg-black text-white py-24">
      <text className="text-4xl">40 FUNDAMENTALS OF ENGLISH RIDING</text>
      <text className="italic text-xl">Author: Hollie H. McNeil</text>
    </div>
    <div className="flex flex-col py-24 px-48 gap-8">
      ...
      <div className="flex flex-col pt-8 justify-center items-center">
        <text>Available at bookstores and tack shops nationwide and at <a className="underline" href="https://www.amazon.com/40-Fundamentals-English-Riding-Essential/dp/1603427899">Amazon.com</a></text>
        <text>40 Fundamentals is published by Storey Publishing.</text>
      </div>
    </div>
  </div>
);
